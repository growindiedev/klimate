...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\n\nbody {\n  display: grid;\n  grid-template-rows: 2fr 6fr 3fr 0.8fr;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n  background-size: cover;\n  color: rgb(251, 251, 251);\n  font-family: Roboto, \"Times New Roman\", Times, serif;\n  text-shadow: 0 0 10px rgba(0, 0, 0, 0.8);\n  height: 100vh;\n}\n.header .upper {\n  display: flex;\n  justify-content: space-between;\n  padding: 0.5rem 1rem;\n}\n.header .temp-toggle-btn, .header .top-date-display {\n  cursor: pointer;\n}\n.header .lower {\n  display: flex;\n  justify-content: center;\n  gap: 1rem;\n}\n.header input {\n  width: 40%;\n  color: rgb(36, 35, 42);\n  font-size: 16px;\n  line-height: 20px;\n  min-height: 28px;\n  border-radius: 4px;\n  padding: 8px 16px;\n  border: 2px solid transparent;\n  box-shadow: rgba(0, 0, 0, 0.12) 0px 1px 3px, rgba(0, 0, 0, 0.24) 0px 1px 2px;\n  background: rgb(251, 251, 251);\n  transition: all 0.1s ease 0s;\n}\n.header input:focus {\n  border: 2px solid rgb(124, 138, 255);\n}\n.header button {\n  display: inline-block;\n  outline: none;\n  cursor: pointer;\n  font-weight: 600;\n  border-radius: 3px;\n  padding: 10px 20px;\n  border: 0;\n  color: #fff;\n  background: #ff5000;\n  line-height: 1.15;\n  font-size: 1.3rem;\n}\n.header button:hover, .header input:hover {\n  transition: all 0.1s ease;\n  box-shadow: 0 0 0 0 #fff, 0 0 0 3px #1de9b6;\n}\n\n.main {\n  display: flex;\n  align-items: start;\n  justify-content: center;\n}\n\n.main-card {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  grid-template-rows: 1fr 1.5fr;\n  gap: 1rem;\n}\n.main-card .place {\n  grid-column: 1/-1;\n  font-size: 5rem;\n  font-weight: 800;\n  justify-self: center;\n  align-self: center;\n}\n.main-card .weather-logo {\n  grid-column: 1/2;\n  grid-row: 2/-1;\n  font-size: 10rem;\n  align-self: center;\n  justify-self: center;\n}\n.main-card .card {\n  grid-column: 2/3;\n  grid-row: 2/-1;\n  font-size: 1.5rem;\n  font-weight: 900;\n  align-self: center;\n}\n.main-card .card .temp {\n  font-size: 4rem;\n}\n\n.weekly-weather {\n  overflow-y: scroll;\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(130px, 1fr));\n  padding: 0 3rem;\n  gap: 1rem;\n}\n.weekly-weather .weekly-card {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  gap: 0.6rem;\n  font-size: 1.2rem;\n  margin-bottom: 1rem;\n}\n.weekly-weather .weekly-card :nth-child(2) {\n  font-size: 4rem;\n}\n\n.footer {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background: rgba(13, 0, 0, 0.325);\n}", "",{"version":3,"sources":["webpack://./src/style.scss"],"names":[],"mappings":"AAGA;EACE,SAAA;EACA,UAAA;EACA,sBAAA;AADF;;AAIA;EACE,aAAA;EACA,qCAAA;EACA,yDAAA;EACA,sBAAA;EACA,yBAAA;EACA,oDAAA;EACE,wCAAA;EAEF,aAAA;AAFF;AAiBE;EACE,aAAA;EACA,8BAAA;EACA,oBAAA;AAfJ;AAkBE;EACE,eAAA;AAhBJ;AAmBE;EACE,aAAA;EACA,uBAAA;EACA,SAAA;AAjBJ;AAoBE;EACE,UAAA;EACA,sBAAA;EACA,eAAA;EACA,iBAAA;EACA,gBAAA;EACA,kBAAA;EACA,iBAAA;EACA,6BAAA;EACA,4EAAA;EACA,8BAAA;EACA,4BAAA;AAlBJ;AAqBE;EACE,oCAAA;AAnBJ;AAsBE;EACE,qBAAA;EACA,aAAA;EACA,eAAA;EACA,gBAAA;EACA,kBAAA;EACA,kBAAA;EACA,SAAA;EACA,WAAA;EACA,mBAAA;EACA,iBAAA;EACA,iBAAA;AApBJ;AAuBE;EACE,yBAAA;EACA,2CAAA;AArBJ;;AAyBA;EACC,aAAA;EACA,kBAAA;EACA,uBAAA;AAtBD;;AA0BA;EACE,aAAA;EAKA,8BAAA;EACA,6BAAA;EACA,SAAA;AA3BF;AAgCE;EACE,iBAAA;EACA,eAAA;EACA,gBAAA;EACA,oBAAA;EACA,kBAAA;AA9BJ;AAiCE;EACE,gBAAA;EACA,cAAA;EACA,gBAAA;EACA,kBAAA;EACA,oBAAA;AA/BJ;AAkCE;EACE,gBAAA;EACA,cAAA;EACA,iBAAA;EACA,gBAAA;EAEA,kBAAA;AAjCJ;AAmCI;EACE,eAAA;AAjCN;;AAsCA;EACE,kBAAA;EAIA,aAAA;EACA,2DAAA;EACA,eAAA;EACA,SAAA;AAtCF;AAwCE;EACE,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,mBAAA;EACA,WAAA;EACA,iBAAA;EACA,mBAAA;AAtCJ;AAuCI;EACE,eAAA;AArCN;;AA0CA;EACE,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,iCAAA;AAvCF","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Press+Start+2P&family=Roboto:wght@300;400&display=swap');\n\n\n* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\n\nbody {\n  display: grid;\n  grid-template-rows: 2fr 6fr 3fr 0.8fr;\n  background-image: url(\"weather.jpeg\");\n  background-size: cover;\n  color:rgb(251, 251, 251);\n  font-family: Roboto, 'Times New Roman', Times, serif;\n    text-shadow: 0 0 10px rgba(0,0,0,.8);\n\n  height: 100vh;\n\n  > * {\n    // border: 1px solid red;\n  }\n\n \n}\n\n.header {\n\n  * {\n    // border: 1px solid green;\n  }\n  \n  .upper {\n    display: flex;\n    justify-content: space-between;\n    padding: 0.5rem 1rem ;\n  }\n\n  .temp-toggle-btn, .top-date-display {\n    cursor: pointer;\n  }\n   \n  .lower {\n    display: flex;\n    justify-content: center;\n    gap: 1rem;\n  }\n\n  input {\n    width: 40%;\n    color: rgb(36, 35, 42);\n    font-size: 16px;\n    line-height: 20px;\n    min-height: 28px;\n    border-radius: 4px;\n    padding: 8px 16px;\n    border: 2px solid transparent;\n    box-shadow: rgb(0 0 0 / 12%) 0px 1px 3px, rgb(0 0 0 / 24%) 0px 1px 2px;\n    background: rgb(251, 251, 251);\n    transition: all 0.1s ease 0s;\n  }\n\n  input:focus {\n    border: 2px solid rgb(124, 138, 255);\n  }\n\n  button {\n    display: inline-block;\n    outline: none;\n    cursor: pointer;\n    font-weight: 600;\n    border-radius: 3px;\n    padding: 10px 20px;\n    border: 0;\n    color: #fff;\n    background: #ff5000;\n    line-height: 1.15;\n    font-size: 1.3rem;\n  }\n\n  button:hover, input:hover {\n    transition: all .1s ease;\n    box-shadow: 0 0 0 0 #fff, 0 0 0 3px #1de9b6;\n  }\n}\n\n.main {\n display: flex;\n align-items: start;\n justify-content: center;\n //border: 1px solid red;\n}\n\n.main-card {\n  display: grid;\n  // width: fit-content;\n  //height: fit-content;\n  //max-width: 40%;\n  // border: 1px solid red;\n  grid-template-columns: 1fr 1fr;\n  grid-template-rows: 1fr 1.5fr;\n  gap: 1rem;\n  > * {\n   // border: 1px solid green;\n  }\n\n  .place {\n    grid-column: 1/-1;\n    font-size: 5rem;\n    font-weight: 800;\n    justify-self: center;\n    align-self: center;\n  }\n\n  .weather-logo {\n    grid-column: 1/2;\n    grid-row: 2/-1;\n    font-size: 10rem;\n    align-self: center;\n    justify-self: center;\n  }\n\n  .card {\n    grid-column: 2/3;\n    grid-row: 2/-1;\n    font-size: 1.5rem;\n    font-weight: 900;\n    // justify-self: center;\n    align-self: center;\n    // font-size: 3rem;\n    .temp {\n      font-size: 4rem;\n    }\n  }\n}\n\n.weekly-weather {\n  overflow-y: scroll;\n  > * {\n    // border: 2px solid white;\n  }\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(130px, 1fr));\n  padding: 0 3rem;\n  gap: 1rem;\n\n  .weekly-card {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    gap:0.6rem;\n    font-size: 1.2rem;\n    margin-bottom: 1rem;\n    :nth-child(2) {\n      font-size: 4rem;\n    }\n  }\n}\n\n.footer {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background: rgba(13, 0, 0, 0.325);\n}"],"sourceRoot":""}]);
// Exports
...
const fetchApi = async (city, tempUnit) => {
  let weatherCall;
  try {
    weatherCall = await axios__WEBPACK_IMPORTED_MODULE_1___default().get(
      `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=${"MISSING_ENV_VAR".WEATHER_API_KEY}&units=${tempUnit}`
    );
    // use localStorage
    (0,_updateDOM__WEBPACK_IMPORTED_MODULE_0__.updateMainCard)(weatherCall.data, tempUnit);
    //console.log(data);
  } catch (error) {
    alert(error);
  }
  ...
  try {
    let forecastCall = await axios__WEBPACK_IMPORTED_MODULE_1___default().get(
    ...
    (0,_updateDOM__WEBPACK_IMPORTED_MODULE_0__.updateForecastCards)(forecastCall.data.daily, tempUnit);
...
const updateMainCard = (data, tempUnit) => {
  let unit = "";
  if (tempUnit == "metric") {
    unit = "C";
...
const updateForecastCards = (data, tempUnit) => {
...
if (!localStorage.getItem("localCity")) {
  ...
  localStorage.setItem("localTemp", "metric");
  (0,_apiFunctions__WEBPACK_IMPORTED_MODULE_1__.getData)();
} else {
  (0,_apiFunctions__WEBPACK_IMPORTED_MODULE_1__.getData)();
}
...
tempToggleBtn.addEventListener("click", _apiFunctions__WEBPACK_IMPORTED_MODULE_1__.toggleTemp);
searchBtn.addEventListener("click", _apiFunctions__WEBPACK_IMPORTED_MODULE_1__.getData);
